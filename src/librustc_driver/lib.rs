...
// Parses args and runs the compiler. This is the primary entry point for rustc.
...
// Extracts output directory and file from matches.
...
// Extracts input (string or file and optional path) from matches.
