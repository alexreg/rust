...
pub struct InterpUserFn {
    /// The placeholder ident. The parser looks for this as a single ident within a block.
    pub placeholder: String,
    /// The body to insert in place of the placeholder ident.
    pub body: Steal<P<ast::Block>>,
}
...
pub struct Parser<'a> {
    ...
    pub interp_user_fn: Option<Lrc<InterpUserFn>>,
}
...
impl<'a> Parser<'a> {
    ...
    pub fn with_interp_user_fn(&mut self, interp_user_fn: Option<Lrc<InterpUserFn>>) -> &mut Self {
